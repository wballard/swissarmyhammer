...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let prompts = vec![
        Prompt::new("rust-optimization", "Help me optimize this Rust code for performance")
            .with_description("Get suggestions for optimizing Rust code")
            .with_category("rust")
            .with_tags(vec!["rust".to_string(), "performance".to_string(), "optimization".to_string()]),
        ...
        Prompt::new("python-debug", "Debug this Python code and find the issue")
            ...
            .with_tags(vec!["python".to_string(), "debugging".to_string(), "troubleshooting".to_string()]),
        ...
        Prompt::new("code-documentation", "Generate documentation for this code")
            ...
            .with_tags(vec!["docs".to_string(), "comments".to_string(), "documentation".to_string()]),
        ...
        Prompt::new("api-design", "Design a REST API for this use case")
            ...
            .with_tags(vec!["api".to_string(), "rest".to_string(), "design".to_string()]),
        
        Prompt::new("sql-optimization", "Optimize this SQL query for better performance")
            .with_description("Improve SQL query performance")
            .with_category("database")
            .with_tags(vec!["sql".to_string(), "database".to_string(), "optimization".to_string()]),
        
        Prompt::new("react-component", "Create a React component with these requirements")
            .with_description("Generate React components")
            .with_category("frontend")
            .with_tags(vec!["react".to_string(), "javascript".to_string(), "component".to_string()]),
    ];
    ...
    #[cfg(feature = "search")]
    {
        ...
        for result in results.iter().take(5) {
            println!("  - {} (score: {:.2}): {}", 
                result.prompt.name, 
                result.score,
                result.prompt.description.as_deref().unwrap_or("No description"));
        }
