...
use swissarmyhammer::{PromptLibrary, Prompt, Template, TemplateEngine, ArgumentSpec};
...
"#;
    ...
    args.insert("title".to_string(), "Hello World! This is a Test".to_string());
...
"#;
    ...
    let prompt = Prompt::new("git-commit", r#"
{{ type }}: {{ description }}
...
"#)
    ...
    args.insert("description".to_string(), "add library API for prompt management".to_string());
