...
mod tests {
    ...
    async fn test_mock_storage_search_functionality() {
        ...
        storage
            ...
            .unwrap();
        storage
            .create_memo("JavaScript Basics".to_string(), "Introduction to JS".to_string())
            .await
            .unwrap();
    ...
    async fn test_mock_storage_context_generation() {
        ...
        // Create memos
        storage.create_memo("First".to_string(), "Content 1".to_string()).await.unwrap();
        storage.create_memo("Second".to_string(), "Content 2".to_string()).await.unwrap();
    ...
    async fn test_mock_storage_capacity_limit() {
        ...
        // Third should fail
        let result = storage.create_memo("Third".to_string(), "Content 3".to_string()).await;
        assert!(result.is_err());
